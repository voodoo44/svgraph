...
Class Square {
    ...
    public function getSVG() {
        ...
        foreach($aElements as $aElement) {
            ...
            $oXmlGridChild->addAttribute('cx', $aElement['cx']);
            $oXmlGridChild->addAttribute('cy', $aElement['cy']);
            $oXmlGridChild->addAttribute('r', $aElement['r']);
            $oXmlGridChild->addAttribute('stroke', $aElement['stroke']);
            $oXmlGridChild->addAttribute('stroke-width', $aElement['stroke-width']);
            $oXmlGridChild->addAttribute('fill', $aElement['fill']);
        }
